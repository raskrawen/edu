...
let lineDist;
let infoBox;
let message = "<h1>Model af neuralt netværk.</h1>v.1.8.<h3>Kroppen gennemløbes af over 86 milliarder <u>nerveceller (neuroner)</u>, som er forbundet og signalerer til hinanden i et <u>netværk</u>. Hver nervecelle består af en <u>cellekrop (soma)</u> og en til flere <u>udløbere (axon'er)</u>.<br><br><I>Numbers</I> viser <u>tærskelværdi</u> og <u>membranpotentiale</u> (sorte), samt hver nervecelles type og ID (hvid). Typen kan være <u>fremmende</u> (stim) eller <u>hæmmende</u> (inhib).<br><br>Enkelte celler er <u>sanseceller</u> (gullige), som aktiveres fx af berøring eller duft. I modellen aktiveres de af og til, men kan også aktiveres af klik med musen.<br><br>Én celle repræsenterer <u>sanseceller</u> fra et øre, og de kan stimuleres via computerens mikrofon, hvis <I>Øre</I> er slået til.<br><br>Nye nerveceller kan dannes ved at klikke mellem de eksisterende.";
//let message; 
let debugging = false;
